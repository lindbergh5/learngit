...
;;
*)
#If user answer anthing but "yes", exit script
    echo
    echo $EXIT_LINE1
    echo $EXIT_LINE2
    echo
...
LINE2="you wish to delete from the system? [y/s]"
get_answer
#
...
#
case $? in
1)  #No processes runing for this User Account
    #
    echo "There are no processes for this account currently runing."
    echo
;;
0)  #processes running for this User Account.
    #Ask Script User if wants us to kill the processes.
    #
    echo "$USER_ACCOUNT has the followiung processes running :"
    echo
    ps -u $USER_ACCOUNT
    #
